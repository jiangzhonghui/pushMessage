...
public class YunPian {
    ...
    public static void sendTSSmsMessage(String mobile,String alert) throws IOException, URISyntaxException{
    	 String text = "【TS交易】交易提醒"+alert;
    	 sendSmsMessage(mobile,text);
    }
    
    public static void sendSmsRegisterCodeMessage(String mobile,String code) throws IOException, URISyntaxException{
   	 String text = "【TS交易】交易提醒"+code;
   	sendSmsMessage(mobile,text);
   }
    
    public static void sendSmsMessage(String mobile,String text) throws IOException, URISyntaxException{
    	//修改为您的apikey.apikey可在官网（http://www.yuanpian.com)登录后获取
        String apikey = "180ff2dd174a0b1484a8c3e4b685be07";

        //修改为您要发送的手机号
        //String mobile = "13928081843";

        /**************** 查账户信息调用示例 *****************/
        System.out.println(YunPian.getUserInfo(apikey));

        /**************** 使用智能匹配模版接口发短信(推荐) *****************/
        //设置您要发送的内容(内容必须和某个模板匹配。以下例子匹配的是系统提供的1号模板）
        //String text = template+alert;
        //发短信调用示例
...
//        System.out.println(YunPian.tplSendSms(apikey, tpl_id, tpl_value, mobile));
    }
